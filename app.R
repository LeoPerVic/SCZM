...
ui <- semanticPage(
  ...
  sidebar_layout(
    ...
    main_panel(
      ...
      selectInput("opcion", "Seleccione una zona metropolitana:", choices = c("1.01", "2.03", "5.01", "5.02", "5.03", "5.04", "6.01", "7.01", "7.02", "8.01", "8.02", "8.03", "8.04", "9.01", "11.01", "11.03", "11.03", "12.02", "13.01", "13.03", "14.01", "14.03", "15.02", "16.01", "16.02", "16.03", "17.01", "17.02", "18.01", "19.01", "20.01", "21.01", "21.02","21.03", "22.01", "23.01", "24.02", "26.01", "27.01", "28.04", "28.05", "29.01", "30.02", "30.03", "30.04", "30.05", "30.06", "30.07", "30.08", "31.01", "32.01"),width = 300),
